...
IMPLEMENT_DYNAMIC(lb_dhSDKdlg, CDialog)

lb_dhSDKdlg::lb_dhSDKdlg(CWnd* pParent /*=NULL*/)
...
lb_dhSDKdlg::~lb_dhSDKdlg()
{
}

void lb_dhSDKdlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(lb_dhSDKdlg)
...
BEGIN_MESSAGE_MAP(lb_dhSDKdlg, CDialog)
	//{{AFX_MSG_MAP(lb_dhSDKdlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
void lb_dhSDKdlg::UpdataScreenPos()
{
...
void lb_dhSDKdlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR lb_dhSDKdlg::OnQueryDragIcon()
{
...
void CALLBACK DisConnectFunc(LLONG lLoginID, char *pchDVRIP, LONG nDVRPort, DWORD dwUser)
{
	if (0 != dwUser)
	{
		lb_dhSDKdlg *dlg = (lb_dhSDKdlg *)dwUser;
		dlg->DeviceDisConnect(lLoginID, pchDVRIP, nDVRPort);
	}
}

//Process when device disconnected 
void lb_dhSDKdlg::DeviceDisConnect(LONG lLoginID, char *sDVRIP, LONG nDVRPort)
{
...
//Play 
void lb_dhSDKdlg::OnBUTTONPlay()
{
	// TODO: Add your control notification handler code here
	//CLIENT_API LONG CLIENT_RealPlayEx(LONG lLoginID, int nChannelID, HWND hWnd);
...
//Get video handle 
HWND lb_dhSDKdlg::GetDispHandle(int nNum)
{
	HWND hWnd = 0;
...
void lb_dhSDKdlg::SetPlayVideoInfo(int iDispNum, int iChannel, enum RealPlayMode ePlayMode)
{
	BOOL bValid = UpdateData(TRUE);
	if (bValid)
	{
...
//PTZ control 
void lb_dhSDKdlg::PtzControl(int type, BOOL stop)
{
...
//Dialogue box zoom 
void lb_dhSDKdlg::OnBtnPtzexctrl()
{
	// TODO: Add your control notification handler code here
...
void lb_dhSDKdlg::InitPTZControl()
{
...
void lb_dhSDKdlg::PtzExtControl(DWORD dwCommand, DWORD dwParam)
{
	if (0 != m_LoginID)
	{
		//Get channel number 
...
//Begin tour 
void lb_dhSDKdlg::OnStartCruise()
{
	// TODO: Add your control notification handler code here
	BOOL bValid = UpdateData(TRUE);
	if (bValid)
...
//Add tour 
void lb_dhSDKdlg::OnCruiseAddPoint()
{
	// TODO: Add your control notification handler code here
	BOOL bValid = UpdateData(TRUE);
	if (bValid)
...
//Delete tour point
void lb_dhSDKdlg::OnCruiseDelPoint()
{
	// TODO: Add your control notification handler code here
	BOOL bValid = UpdateData(TRUE);
	if (bValid)
...
//Delete tour group 
void lb_dhSDKdlg::OnCruiseDelGroup()
{
	// TODO: Add your control notification handler code here
	BOOL bValid = UpdateData(TRUE);
	if (bValid)
...
//Begin record 
void lb_dhSDKdlg::OnModeSetBegin()
{
	// TODO: Add your control notification handler code here
	BOOL bValid = UpdateData(TRUE);
	if (bValid)
...
//Delete pattern 
void lb_dhSDKdlg::OnModeSetDelete()
{
	// TODO: Add your control notification handler code here
	BOOL bValid = UpdateData(TRUE);
	if (bValid)
...
//Set left limit
void lb_dhSDKdlg::OnLineSetLeft()
{
	// TODO: Add your control notification handler code here
...
//Set right limit 
void lb_dhSDKdlg::OnLineSetRight()
{
	// TODO: Add your control notification handler code here
...
//Begin rotation 
void lb_dhSDKdlg::OnRotateStart()
{
	// TODO: Add your control notification handler code here
...
void lb_dhSDKdlg::OnAuxClose()
{
	// TODO: Add your control notification handler code here
	PtzExtControl(DH_EXTPTZ_AUXICLOSE);
}

void lb_dhSDKdlg::OnBtnPtzmenu()
{
	// TODO: Add your control notification handler code here
	if (0 == m_LoginID)
	{
...
//Play video directly 
void lb_dhSDKdlg::DirectPlayMode(int iDispNum, int iChannel, HWND hWnd)
{
	//Close current video 
	CloseDispVideo(iDispNum);
...
void lb_dhSDKdlg::ServerPlayMode(int iDispNum, int iChannel, HWND hWnd)
{
	//Close current video 
	CloseDispVideo(iDispNum);
...
void lb_dhSDKdlg::ReceiveRealData(LONG lRealHandle, DWORD dwDataType, BYTE *pBuffer, DWORD dwBufSize)
{
...
long lb_dhSDKdlg::GetStreamPort(long lRealHandle)
{
	long lPort = 0;
	for (int i = 0; i<9; i++)
	{
...
void lb_dhSDKdlg::StopPlayForDirectMode(int iDispNum)
{
...
void lb_dhSDKdlg::StopPlayForServerMode(int iDispNum)
{
...
void lb_dhSDKdlg::MultiPlayMode(int iDispNum, HWND hWnd)
{
	//Close current video 
	CloseDispVideo(iDispNum);
...
BOOL lb_dhSDKdlg::SetMultiSpliteMode(int nChannel, int nMultiPlay)
{
	// 获取PrevViewMode
...
void lb_dhSDKdlg::StopPlayForMultiMode(int iDispNum)
{
	if (0 != m_DispHanle[iDispNum - 1])
	{
		BOOL bRet = CLIENT_StopRealPlayEx(m_DispHanle[iDispNum - 1]);
...
//Display log in failure reason 
void lb_dhSDKdlg::ShowLoginErrorReason(int nError)
{
...
void lb_dhSDKdlg::MultiPlayServerMode(int iDispNum, HWND hWnd)
{
	//Close current video 
	CloseDispVideo(iDispNum);
...
void lb_dhSDKdlg::StopPlayForMultiServer(int iDispNum)
{
	//First close CLIENT_RealPlay
	if (0 != m_DispHanle[iDispNum - 1])
	{
...
////Close video 
void lb_dhSDKdlg::CloseDispVideo(int iDispNum)
{
	//Close current video 
...
BOOL lb_dhSDKdlg::GetParams(int nWndID, int type)
{
	BOOL bRet = FALSE;
...
void lb_dhSDKdlg::SetParams(int nWndID, int type)
{
	if (type == 0)
	{
...
void lb_dhSDKdlg::MessageProc(int nWndID, UINT message)
{
	switch (message)
	{
	case WM_LBUTTONDOWN:
...
BOOL lb_dhSDKdlg::GetExitDecode(int nCurWndID)
{
	BOOL bRet = FALSE;
...
BOOL lb_dhSDKdlg::GetExitCycle(int nCurWndID)
{
	BOOL bRet = FALSE;
	if (nCurWndID<0 || nCurWndID >= 16)
	{
...
void lb_dhSDKdlg::SetExitDecode(int nCurWndID)
{
	if (nCurWndID<0 || nCurWndID >= 16)
	{
		return;
...
void lb_dhSDKdlg::SetExitCycle(int nCurWndID)
{
	if (nCurWndID<0 || nCurWndID >= 16)
	{
		return;
...
void lb_dhSDKdlg::OnSelchangeCOMBODispNum()
{
	// TODO: Add your control notification handler code here
...
void lb_dhSDKdlg::OnCloseupCOMBODispNum()
{
	// TODO: Add your control notification handler code here
